...
export default async function Page() {
    ...
    return (
        <>
        <Header />
        <div className="container flex flex-col  mx-auto w-full my-8 gap-1">
        <div className=" flex flex-col  w-full text-xl font-semibold  text-basic-preto ">Dashboard</div>
