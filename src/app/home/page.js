      ...
      <div className="container flex flex-col  mx-auto w-full p-4 ">
        ...
        <div className=' flex flex-row w-full my-2 gap-2'>
          <Card backgroundColor="bg-green-600" h1='Concluídas'>
            <span className="flex flex-row w-full text-neutral-600 font-semibold text-xl">{counts.concluida}</span>
          </Card>
          <Card backgroundColor="bg-red-600" h1='Não conforme'>
            <span className="flex flex-row w-full text-neutral-600 font-semibold text-xl">{counts.cancelada}</span>
          </Card>
          <Card backgroundColor="bg-zinc-600" h1='Pendente'>
            <span className="flex flex-row w-full text-neutral-600 font-semibold text-xl">{counts.pendente}</span>
          </Card>
          <Card backgroundColor="bg-yellow-600" h1='Em andamento'>
            <span className="flex flex-row w-full text-neutral-600 font-semibold text-xl">{counts.emAndamento}</span>
          </Card>
          <Card backgroundColor="bg-cyan-600" h1='Total'>
            <span className="flex flex-row w-full text-neutral-600 font-semibold text-xl">{counts.total}</span>
          </Card>
        </div>
        <div>
          <Table />
